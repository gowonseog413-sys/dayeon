...
export const DEFAULT_CATEGORY_TREE: CategoryTreeNode[] = [
  {
    ...
    sortOrder: 1,
    children: [
      { id: "all", label: "전체 컬러렌즈", sortOrder: 1, href: "/catalog?category=contact-lenses", children: [] },
      {
        id: "brand",
        label: "브랜드별",
        sortOrder: 2,
        children: [
          { id: "bloominc", label: "다연 추천", sortOrder: 1, href: "/catalog?category=contact-lenses&brand=Bloominc", children: [] },
      ...
      },
      {
        ...
        sortOrder: 3,
        children: [
          { id: "natural", label: "일상 · 내추럴", sortOrder: 1, href: "/catalog?category=contact-lenses&look=natural", children: [] },
          { id: "no-ring", label: "노링 스타일", sortOrder: 2, href: "/catalog?category=contact-lenses&look=no-ring", children: [] },
          { id: "with-ring", label: "선명한 링라인", sortOrder: 3, href: "/catalog?category=contact-lenses&look=with-ring", children: [] },
          { id: "big-eye", label: "또렷한 눈매", sortOrder: 4, href: "/catalog?category=contact-lenses&look=big-eye", children: [] },
          { id: "wedding", label: "웨딩 & 기념일", sortOrder: 5, href: "/catalog?category=contact-lenses&look=wedding", children: [] },
          { id: "bright", label: "화사한 눈빛", sortOrder: 6, href: "/catalog?category=contact-lenses&look=bright", children: [] },
          { id: "sensitive", label: "민감 눈 맞춤", sortOrder: 7, href: "/catalog?category=contact-lenses&look=sensitive", children: [] },
        ],
      },
      {
        id: "color",
